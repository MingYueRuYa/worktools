...
public:
  ...
  void activateOn( QWidget* topLevelWidget, BOOL bMoveTopLevel=FALSE );
  ...
  bool isUsingRubberBandOnResize();

  void setRectRubberBandOnMove( QRect rect );
  QRect rectRubberBandOnMove();
  ...
  void setWidgetDesktopRect(QWidget* topLevelWidget);
  
  void addExcludeRect(const QRect &rcRect);
  void clearEsxcludeRect();
